...
function employeeUpdater() {
  ...
  employees[i].firstName === 'Theo' ? employees.splice(i,1) : null;
...
function recordCleaner () {
  myCar.accidents.map(v => {
    v.atFaultForAccident = false;
  });
};
